...
(function () {
    ...
    style.textContent = [
        ...
        '}',
        '#mlw-chat-widget-btn svg { width: 1.75rem; height: 1.75rem; fill: #fff; }',
        '',
        ...
        '    z-index: 2147483647;',
        '  }',
        '  #mlw-chat-widget-btn { bottom: 5rem; left: 1rem; width: 3.5rem; height: 3.5rem; z-index: 2147483646; }',
        '}',
        ...
        '    z-index: 2147483647;',
        '  }',
        '  #mlw-chat-widget-btn { bottom: 5rem; left: 1rem; z-index: 2147483646; }',
        '}',
    ].join('\n');

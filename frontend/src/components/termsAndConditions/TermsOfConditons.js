...
export default function TermsOfConditons() {
    return (
        <SimpleContainer className="lw-terms">
            ...
            <Text12 className="lw-terms__mt8">{`תאריך עדכון אחרון: ${DateDDMMYY(new Date())}`}</Text12>
            <Text16 className="lw-terms__mt12">ברוכים הבאים לאתר ולשירותי MelamedLaw. השימוש באתר ובשירותים שלנו מותנה בקבלתך את תנאי השימוש המפורטים להלן.</Text16>
            <TextBold24 className="lw-terms__mt16">1. הסכמה לתנאים</TextBold24>
            <Text16 className="lw-terms__mt8">• על ידי שימוש באתר או בשירותים שלנו, אתה מסכים לתנאי השימוש ולמדיניות הפרטיות שלנו. אם אינך מסכים לתנאים אלו, עליך להימנע משימוש בשירותים שלנו.</Text16>

            <TextBold24 className="lw-terms__mt16">2. השירותים שאנו מספקים</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>{`אנו מספקים שירותי ניהול תיקים משפטיים הכוללים:
            ...
            <TextBold24 className="lw-terms__mt16">3. הרשמה וחשבונות משתמש</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>
            ...
            <TextBold24 className="lw-terms__mt16">4. פרטיות והגנה על מידע</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>
            ...
            <TextBold24 className="lw-terms__mt16">5. שימוש הוגן ואיסורים</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>
            ...
            <TextBold24 className="lw-terms__mt16">6. אחריות ושיפוי</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>
            ...
            <TextBold24 className="lw-terms__mt16">7. שינויים ועדכונים</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>
            ...
            <TextBold24 className="lw-terms__mt16">8. יצירת קשר</TextBold24>
            <Text16 className="lw-terms__mt8" shouldApplyClamping>

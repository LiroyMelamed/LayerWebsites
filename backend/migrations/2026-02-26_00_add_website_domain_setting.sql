...
VALUES
    ('firm', 'COMPANY_NAME',   'MorLevy',              'string', 'שם החברה (אנגלית)',  'שם החברה באנגלית — מופיע בהודעות SMS ללקוחות, באימיילים שנשלחים מהמערכת, ובהודעות ברוכים הבאים ללקוחות חדשים'),

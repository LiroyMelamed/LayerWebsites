...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'FIRM_OFFICE_ADDRESS'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'CALENDAR_EVENT_TYPE_COLORS'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'DAILY_AGENDA_ENABLED'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'DAILY_AGENDA_CHANNELS'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'DAILY_AGENDA_RECIPIENTS'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'DAILY_AGENDA_SEND_TIME'
);
...
WHERE NOT EXISTS (
    SELECT 1 FROM platform_settings WHERE category = 'calendar' AND key = 'DAILY_AGENDA_LAST_SENT_DATE'
);
